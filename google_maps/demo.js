...
demo = (function(demo) {
  demo.maps = (function(maps) {
    var injectScript, mapData, setData;
    maps.render = function(data) {
      setData(data);
      return injectScript();
    };
  ...
  return demo.maps.render([
    {
      ...
      addresses: ["12975 Vallejo Circle, Denver, CO 80234", "7501 E Lowry Blvd, Denver, CO 80230"]
    }
  ]);
});
